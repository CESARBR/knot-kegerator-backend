...
test('list() calls ListClients.execute()', async (t, clientService) => {
...
test('list() returns Clients returned by ListClients.execute()', async (t, clientService) => {
  ...
  const actualClients = await clientService.list();
