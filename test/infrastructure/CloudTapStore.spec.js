...
test(
  'CloudTapStore.get() returns CloudTap filled with sensor values returned by getDataFromSensor()',
  async (t, cloudConnection) => {
    ...
    const expectedCloudTap = new CloudTap(
      '46dcecf4-968f-4a0f-bbad-47b6debf0008',
      false,
      15.4,
    );

    const actualCloudTap = await cloudTapStore.get('46dcecf4-968f-4a0f-bbad-47b6debf0008');

    t.deepEqual(actualCloudTap, expectedCloudTap);
    t.end();
  },
);
